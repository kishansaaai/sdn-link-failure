...
4. Once in Mininet CLI run these one by one:
pingall
pingall
dpctl dump-flows
link s1 s2 down
...
## Proof of Execution
See cn-screenshots.pdf in this repository for screenshots of all scenarios including flow tables and ping results.
